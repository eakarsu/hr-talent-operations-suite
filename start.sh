...
PORT="${PORT:-4550}"
DB_NAME="${PGDATABASE:-hr_talent_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      HR Talent Operations Suite"
echo "======================================="
echo
...
echo "Starting hr talent operations suite frontend on http://localhost:$PORT"
echo "Login: admin@hr-talent.local / admin123"
