...
const seed: NotificationItem[] = [
  { id: 'note-1', title: 'Employees alert', detail: 'Employees queue needs review.', read: false },
  { id: 'note-2', title: 'Onboarding approval due', detail: 'Onboarding exception list needs approval.', read: false },
  { id: 'note-3', title: 'Benefits updated', detail: 'Benefits operating queue was refreshed.', read: true },
];
