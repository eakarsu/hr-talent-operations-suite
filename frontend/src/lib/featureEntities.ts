...
const entitySeeds = [
  ...
  ["shift-planning","Shift Planning Records","Shift Planning operating queue","Open","Shift Planning follow-up list","Workforce Scheduling Shift Planner","$0"],
  ["coverage-gaps","Coverage Gaps Records","Coverage Gaps operating queue","Review","Coverage Gaps follow-up list","Workforce Scheduling Shift Planner","$0"],
  ["labor-capacity-forecast","Labor Capacity Forecast Records","Labor Capacity Forecast operating queue","Review","Labor Capacity Forecast follow-up list","Workforce Scheduling Shift Planner","$0"],
