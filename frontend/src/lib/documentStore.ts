...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Employees Packet', type: 'Employees', owner: 'People Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Onboarding Review Bundle', type: 'Onboarding', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
  { id: 'doc-3', name: 'Benefits Evidence Set', type: 'Benefits', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
