...
const featureSeeds = [
  ['employees', 'Employees', 'Employees operating queue', 'People Lead', 'Review and assign next action'],
  ['onboarding', 'Onboarding', 'Onboarding operating queue', 'People Lead', 'Review and assign next action'],
  ['benefits', 'Benefits', 'Benefits operating queue', 'People Lead', 'Review and assign next action'],
  ['performance', 'Performance', 'Performance operating queue', 'People Lead', 'Review and assign next action'],
  ['learning', 'Learning', 'Learning operating queue', 'Operations Lead', 'Review and assign next action'],
  ['engagement', 'Engagement', 'Engagement operating queue', 'Operations Lead', 'Review and assign next action'],
  ['compensation', 'Compensation', 'Compensation operating queue', 'Operations Lead', 'Review and assign next action'],
  ['time-off', 'Time Off', 'Time Off operating queue', 'Operations Lead', 'Review and assign next action'],
  ['cases', 'Cases', 'Cases operating queue', 'Governance Lead', 'Review and assign next action'],
  ['policies', 'Policies', 'Policies operating queue', 'Governance Lead', 'Review and assign next action'],
  ['org-planning', 'Org Planning', 'Org Planning operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
  ['reports', 'Reports', 'Reports operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
  ["shift-planning","Shift Planning","Shift Planning review queue","Workforce Scheduling Shift Planner","Review source context and assign owner"],
  ["coverage-gaps","Coverage Gaps","Coverage Gaps review queue","Workforce Scheduling Shift Planner","Confirm next action and update evidence"],
  ["labor-capacity-forecast","Labor Capacity Forecast","Labor Capacity Forecast review queue","Workforce Scheduling Shift Planner","Confirm next action and update evidence"],
