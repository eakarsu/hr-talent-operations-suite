...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="HR Talent Operations Dashboard"
      subtitle="One merged hr talent operations view for Employees, Onboarding, Benefits, Performance, Learning, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared hr talent operations jobs into one surface. Employees, Onboarding, Benefits, Performance, Learning, Engagement, documents, audit, and AI are presented as platform features.</div>
